...
class SendClientReservationEmail implements ShouldQueue
{
    ...
    public function handle()
    {
        try {
            ...
            Log::info('Sending client reservation email', [
                'to' => $this->to,
            ...
            Log::info('Client reservation email sent successfully', [
                'to' => $this->to,
            ]);

        } catch (Throwable $exception) {
            Log::error('Failed to send client reservation email', [
                'to' => $this->to,
    ...
    {
        Log::error('Client reservation email job failed permanently', [
            'to' => $this->to,
            'error' => $exception->getMessage(),
    ...
    {
        return ['email', 'client', 'reservation', $this->to];
    }
}
