...
<form method="POST" action="{{ $editing ? route('manager.slots.place.slots.update', [$placeId, $slot->id]) : route('manager.slots.place.slots.store', $placeId) }}">
    @csrf
    @if($editing)
        @method('PUT')
    @endif
    ...
    <div class="d-flex justify-content-between">
        <a href="{{ route('manager.slots.place.slots.index', $placeId) }}" class="btn btn-secondary">Cancel</a>
