...
<form method="POST" action="{{ $editing ? route('manager.slots.table.slots.update', [$tableId, $slot->id]) : route('manager.slots.table.slots.store', $tableId) }}">
    @csrf
    @if($editing)
        @method('PUT')
    @endif
    ...
    <div class="d-flex justify-content-between">
        <a href="{{ route('manager.slots.table.slots.index', $tableId) }}" class="btn btn-secondary">Cancel</a>
