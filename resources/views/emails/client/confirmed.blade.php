                          ...
                          <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                            ...
                            <div class="space-y-4">
                              ...
                              <p class="text-center" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="center">
                                ...
                                დაჯავშნის დასასრულებლად, გთხოვ, გადაიხადოთ {{ $reservation->price ?? '0' }} ₾.
                              </p>
                              <table class="s-4 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                <img class="w-200" src="https://foodly.space/assets/images/email/confirmation.png"
                                style="display: block;
                                margin-left: auto;
                                margin-right: auto;"
                                width="200">
                            ...
                            <br>
                            <table class="btn btn-red-500 mt-3 rounded-full px-6 w-full w-lg-48"  role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-radius: 9999px; border-collapse: separate !important; width: 192px;" width="192">
                                <tbody style="margin-top: 20px">
                                  <tr>
                                    <td style="line-height: 24px; font-size: 16px; border-radius: 9999px; width: 192px; margin: 0;" align="center" bgcolor="#dc3545" width="192">
                                      <a href="https://foodly.space/reservation/pay/{{ $reservation->id }}". style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 9999px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: #F16654; padding: 8px 24px; border: 1px solid #F16654;">გადახდა</a>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
