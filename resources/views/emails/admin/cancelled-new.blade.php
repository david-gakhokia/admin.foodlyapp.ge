...
<head>
    ...
    <title>რეზერვაცია გაუქმდა - Foodly</title>
    <style type="text/css">
        /* Reset styles */
                ...
                <table class="email-container" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="max-width: 600px;">
                    ...
                    <tr>
                        <td class="content" style="background: #ffffff; padding: 40px 30px; text-align: center;">
                            ...
                            <h1 class="main-title">რეზერვაცია გაუქმებულია</h1>
                            ...
                            <div class="message-box">
                                <p class="message-text">
                                    სამწუხაროდ, თქვენი რეზერვაცია გაუქმდა. ეს შეიძლება მოხდა სხვადასხვა მიზეზით. 
                                    დამატებითი ინფორმაციისთვის გთხოვთ დაგვიკავშირდეთ ქვემოთ მოცემული კონტაქტებით.
                                </p>
                            </div>
                    ...
                    <!-- Footer -->
                    <tr>
                        <td class="footer" style="background: #7f1d1d; color: #ffffff; padding: 30px 20px; text-align: center;">
                            <div class="footer-brand">🍽️ FOODLY</div>
                            
                            <div class="footer-contact">
                                📧 <a href="mailto:info@foodly.space" style="color: #fca5a5;">info@foodly.space</a><br>
                                📞 <a href="tel:+995322152024" style="color: #fca5a5;">(+995) 032 215 20 24</a><br>
                                🌐 <a href="https://foodly.space" target="_blank" style="color: #fca5a5;">www.foodly.space</a>
                            </div>
                            
                            <div class="footer-note">
                                ნადიმი, რომ ეს მოხდა. იმედი გვაქვს მომავალში გვენახავით <strong style="color: #ef4444;">Foodly</strong>-ში!
                            </div>
                        </td>
                    </tr>
