                                                            ...
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; border-radius: 24px; margin: 0; padding: 40px;"
                                                                    ...
                                                                    <h3 class="text-center"
                                                                        style="padding-top: 0; padding-bottom: 0; color: #e6bd06;font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;"
                                                                    ...
                                                                    <table class="p-2 w-full" border="0"
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td class="fw-700 border-top"
                                                                                    style="line-height: 24px; font-size: 16px; border-top-width: 1px !important;  width: 100%; font-weight: 700 !important; margin: 0; padding: 8px;"
                                                                                    align="left" width="100%">
                                                                                    {{ __('Status') }}</td>
                                                                                <td class="fw-700 text-right border-top"
                                                                                    style="line-height: 24px; font-size: 16px; color:#bda20e; border-top-width: 1px !important;  width: 100%; font-weight: 700 !important; margin: 0; padding: 8px;"
                                                                                    align="right" width="100%">{{__('Pending')}}
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
