<x-layouts.app title="Create New Space">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-8">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold text-gray-900">Create New Space</h1>
                        <p class="text-gray-600 text-lg">Add a new space to your restaurant</p>
                    </div>
                </div>
