<x-layouts.app title="Edit Space">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-8">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold text-gray-900">Edit Space</h1>
                        <p class="text-gray-600 text-lg">Update space information and settings</p>
                    </div>
                </div>
            ...
            @if ($space->image)
                <div class="bg-white backdrop-blur-sm shadow-xl rounded-2xl border border-gray-200 p-6 mb-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <form action="{{ route('admin.spaces.image.delete', $space->id) }}" method="POST"
