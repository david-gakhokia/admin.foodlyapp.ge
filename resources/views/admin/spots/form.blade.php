...
<div class="p-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div>
                ...
                <input type="text" name="slug"
                    value="{{ old('slug', isset($spot) ? $spot->slug : '') }}"
                    class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-purple-500 focus:ring-2 focus:ring-purple-500 focus:ring-opacity-20 transition-all duration-200 text-sm bg-gray-50 focus:bg-white px-4 py-3"
            ...
            <div>
                ...
                <select name="status"
                    ...
                    @foreach(\App\Models\Spot::getStatuses() as $value => $label)
                        <option value="{{ $value }}" @selected(old('status', isset($spot) ? $spot->status : 'active') === $value)>
    ...
    <div class="border-t border-gray-200 pt-8 mb-8">
        ...
        @if (!empty($spot->image) && isset($spot))
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">
                    {{ isset($spot) && !empty($spot->image) ? 'Replace Image' : 'Upload Image' }}
                </label>
