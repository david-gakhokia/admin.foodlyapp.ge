<x-layouts.app title="Cities Management">
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <form method="GET" class="mb-6 flex gap-4">
            ...
            <select name="status"
                class="rounded-xl border-gray-300 px-4 py-2 focus:border-purple-500 focus:ring-2 focus:ring-purple-500">
            ...
            <button type="submit"
                class="bg-purple-600 text-white px-4 py-2 rounded-xl font-medium hover:bg-purple-700 transition-all">Filter</button>
        </form>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead>
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700">Image</th>
