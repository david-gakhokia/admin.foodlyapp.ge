<x-layouts.app :title="'Restaurant რედაქტირება - ' . $dish->name">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-lg">{{ $restaurant->name }} - {{ $dish->name }}</p>
                        </div>
                    </div>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-xl border border-gray-200 shadow-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                    ...
                    <p class="text-sm text-gray-600 mt-1">შეცვალეთ dish-restaurant კავშირის status და rank</p>
                </div>
                
                <form action="{{ route('admin.dishes.restaurants.update', [$dish, $restaurant]) }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
