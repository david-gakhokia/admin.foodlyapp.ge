<x-layouts.app :title="'Restaurant დამატება - ' . $cuisine->name">
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-lg">{{ $cuisine->name }} cuisine-ისთვის</p>
                        </div>
                    </div>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-xl border border-gray-200 shadow-lg overflow-hidden">
                ...
                <form action="{{ route('admin.cuisines.restaurants.store', $cuisine) }}" method="POST" class="p-6">
                    @csrf
