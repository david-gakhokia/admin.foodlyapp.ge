<x-layouts.app title="Create Kiosk">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-2 text-lg">Add a new kiosk device to your system</p>
                    </div>
            ...
            <div class="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-200">
                <div class="px-8 py-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Please fill in all required fields to create a new kiosk</p>
                </div>
                
                <form action="{{ route('admin.kiosks.store') }}" method="POST" class="p-8">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="kiosk" {{ old('mode') == 'kiosk' ? 'selected' : '' }}>Kiosk Mode</option>
                                <option value="admin" {{ old('mode') == 'admin' ? 'selected' : '' }}>Admin Mode</option>
                            </select>
                            @error('mode')
                                <p class="mt-1 text-sm text-red-600 flex items-center gap-1">
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
