<x-layouts.app :title="'ახალი Table Slot - ' . ($table->translate('ka')->name ?? $table->translate('en')->name ?? 'მაგიდა #' . $table->id)">
    <!-- Header -->
    <div class="mb-8">
        <!-- Breadcrumb -->
            ...
            <ol class="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-xl px-6 py-3 shadow-lg">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('admin.restaurants.places.show', [$restaurant, $place]) }}" class="ml-2 text-sm font-semibold text-gray-600 hover:text-blue-600 transition-all duration-200">
                            {{ $place->translate('ka')->name ?? $place->translate('en')->name ?? 'ადგილი' }}
                        </a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('admin.restaurants.places.tables.show', [$restaurant, $place, $table]) }}" class="ml-2 text-sm font-semibold text-gray-600 hover:text-blue-600 transition-all duration-200">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-2 text-sm font-bold text-blue-600 bg-blue-50 px-3 py-1 rounded-xl">ახალი TimeSlot</span>
                    </div>
                </li>
            </ol>
        </nav>
            ...
            <div class="relative flex items-center gap-6">
                ...
                <div>
                    <h1 class="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-gray-800 via-gray-900 to-blue-900 mb-3 leading-tight">
                        ახალი Table TimeSlot
                    </h1>
                    <p class="text-lg text-gray-600 font-semibold">{{ $table->translate('ka')->name ?? $table->translate('en')->name ?? 'მაგიდა #' . $table->id }}-ისთვის</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-br from-white via-gray-50 to-blue-50 backdrop-blur-lg shadow-2xl border border-gray-200/50 rounded-3xl overflow-hidden">
        <div class="bg-gradient-to-r from-blue-400 via-indigo-500 to-purple-600 px-8 py-6">
            <h2 class="text-2xl font-black text-white drop-shadow-md">TimeSlot-ის ინფორმაცია</h2>
        </div>
        
        <div class="p-8">
            <form action="{{ route('admin.restaurants.places.tables.slots.store', [$restaurant, $place, $table]) }}" method="POST" class="space-y-8">
                @csrf
                ...
                <div>
                    ...
                    <select name="day_of_week" id="day_of_week" 
                            class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all duration-300 bg-white shadow-md @error('day_of_week') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <select name="slot_interval_minutes" id="slot_interval_minutes" 
                            class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all duration-300 bg-white shadow-md @error('slot_interval_minutes') border-red-500 @enderror">
                    ...
                    <div class="flex gap-6">
                        <label class="inline-flex items-center">
                            <input type="radio" 
                                   ...
                                   class="w-5 h-5 text-blue-600 border-2 border-gray-300 focus:ring-blue-500 focus:ring-4">
                ...
                <div class="flex gap-4 pt-6 border-t border-gray-200">
                    <button type="submit" 
                            class="flex-1 inline-flex justify-center items-center px-6 py-4 bg-gradient-to-r from-blue-500 via-indigo-600 to-purple-600 hover:from-blue-600 hover:via-indigo-700 hover:to-purple-700 text-white font-bold text-lg rounded-2xl shadow-2xl transition-all duration-300 transform hover:scale-105">
