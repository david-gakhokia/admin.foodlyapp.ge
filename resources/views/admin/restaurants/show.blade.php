<x-layouts.app :title="'რესტორნის დეტალები'">
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50">
        <!-- Modern Hero Section -->
        <div class="relative overflow-hidden bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 rounded-3xl mb-8 shadow-2xl border border-white/20">
                        ...
                        <div class="relative group">
                            ...
                            @else
                                <div class="w-28 h-28 rounded-3xl shadow-2xl flex items-center justify-center bg-white/90 border-2 border-white/50 group-hover:scale-105 transition-transform duration-300">
                                    <span class="text-5xl text-gray-700 font-bold">{{ Str::substr($restaurant->name ?? 'R', 0, 1) }}</span>
                                </div>
                            @endif
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex flex-wrap gap-4 mb-4">
                                @if($restaurant->creator)
                                    <span class="inline-flex items-center px-2 py-1 bg-white/15 rounded text-xs text-white/80">
                                ...
                                <span class="inline-flex items-center px-2 py-1 bg-white/15 rounded text-xs text-white/80">
                                    ...
                                    შექმნის დრო: {{ $restaurant->created_at ? $restaurant->created_at->format('Y-m-d H:i') : '-' }}
                                </span>
                            ...
                            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <div class="text-center bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/20">
                                    <div class="text-2xl font-bold text-white">{{ $restaurant->places->sum(fn($place) => $place->tables->count()) }}</div>
                                    <div class="text-xs text-white/70">მაგიდები</div>
                                </div>
                                <div class="text-center bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/20">
                                    <div class="text-2xl font-bold text-white">{{ $restaurant->menuCategories->count() }}</div>
                                    <div class="text-xs text-white/70">კატეგორიები</div>
                                </div>
                                <div class="text-center bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/20">
                                    <div class="text-2xl font-bold text-white">{{ $restaurant->reservationSlots->count() }}</div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div class="xl:col-span-2 space-y-8">
                ...
                <div class="bg-white/90 backdrop-blur-lg rounded-3xl shadow-xl border border-white/30 overflow-hidden hover:shadow-2xl transition-all duration-500 group">
                    <div class="relative bg-gradient-to-r from-slate-600 via-blue-600 to-indigo-600 px-8 py-6">
                        <div class="absolute inset-0 bg-black/10"></div>
                        <div class="relative flex items-center justify-between">
                            <div class="flex items-center">
                                <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center mr-4 shadow-lg group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div class="p-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="group/item">
                                ...
                                <div class="bg-gradient-to-br from-indigo-50 via-blue-50 to-purple-50 rounded-xl p-4 border-l-4 border-indigo-500 group-hover/item:shadow-lg transition-all duration-300">
                                    <p class="text-gray-900 font-medium">{{ $restaurant->translations->where('locale', 'ka')->first()?->name ?? ($restaurant->name ?? 'მითითებული არ არის') }}</p>
                                </div>
                            </div>
                            ...
                            <div class="group/item">
                                ...
                                <div class="bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50 rounded-xl p-4 border-l-4 border-blue-500 group-hover/item:shadow-lg transition-all duration-300">
                                    <p class="text-gray-900 font-medium">{{ $restaurant->translations->where('locale', 'en')->first()?->name ?? ($restaurant->name ?? 'Not specified') }}</p>
                                </div>
                            </div>
                            ...
                            <div class="group/item">
                                ...
                                <div class="bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 rounded-xl p-4 border-l-4 border-emerald-500 group-hover/item:shadow-lg transition-all duration-300">
                                    <p class="text-gray-900 font-medium font-mono">{{ $restaurant->slug ?? 'მითითებული არ არის' }}</p>
                                </div>
                            </div>
                            ...
                            <div class="group/item">
                                ...
                                <div class="bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50 rounded-xl p-4 border-l-4 border-purple-500 group-hover/item:shadow-lg transition-all duration-300">
                                    <div class="flex items-center justify-between">
                                        <p class="text-gray-900 font-medium capitalize">{{ $restaurant->status ?? 'უცნობი' }}</p>
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $restaurant->status === 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
                            ...
                            @if($restaurant->ranking)
                                ...
                                <div class="group/item">
                                    ...
                                    <div class="bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 rounded-xl p-4 border-l-4 border-amber-500 group-hover/item:shadow-lg transition-all duration-300">
                            ...
                            @if($restaurant->discount)
                                ...
                                <div class="group/item">
                                    ...
                                    <div class="bg-gradient-to-br from-red-50 via-pink-50 to-rose-50 rounded-xl p-4 border-l-4 border-red-500 group-hover/item:shadow-lg transition-all duration-300">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    @if ($kaDesc)
                                        <div>
                                            ...
                                            <div class="bg-gray-50 rounded-xl p-4 text-gray-800 leading-relaxed">{{ $kaDesc }}</div>
                                        </div>
                                    @endif
                                    @if ($enDesc)
                                        <div>
                                            <h5 class="text-sm font-semibold text-gray-700 mb-2">English</h5>
                                            <div class="bg-gray-50 rounded-xl p-4 text-gray-800 leading-relaxed">{{ $enDesc }}</div>
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                @if ($restaurant->email)
                                    <div class="group/contact">
                                        ...
                                        <div class="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-xl p-4 border-l-4 border-blue-500 group-hover/contact:shadow-lg transition-all duration-300">
                                            <a href="mailto:{{ $restaurant->email }}" class="text-blue-600 hover:text-blue-800 font-medium">{{ $restaurant->email }}</a>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if ($restaurant->phone)
                                    <div class="group/contact">
                                        ...
                                        <div class="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 rounded-xl p-4 border-l-4 border-green-500 group-hover/contact:shadow-lg transition-all duration-300">
                                            <a href="tel:{{ $restaurant->phone }}" class="text-green-600 hover:text-green-800 font-medium">{{ $restaurant->phone }}</a>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if ($restaurant->whatsapp)
                                    <div class="group/contact">
                                        ...
                                        <div class="bg-gradient-to-br from-green-50 via-emerald-50 to-green-50 rounded-xl p-4 border-l-4 border-green-500 group-hover/contact:shadow-lg transition-all duration-300">
                                            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $restaurant->whatsapp) }}" target="_blank" class="text-green-600 hover:text-green-800 font-medium flex items-center">
                                                {{ $restaurant->whatsapp }}
                                ...
                                @if ($restaurant->address)
                                    <div class="md:col-span-2 group/contact">
                                        ...
                                        <div class="bg-gradient-to-br from-red-50 via-pink-50 to-rose-50 rounded-xl p-4 border-l-4 border-red-500 group-hover/contact:shadow-lg transition-all duration-300">
                                            <p class="text-gray-900 font-medium leading-relaxed">{{ $restaurant->address }}</p>
                                        </div>
                                    </div>
                                @endif
                            </div>
                        ...
                        @if ($restaurant->reservationSlots->count() > 0)
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                @foreach ($restaurant->reservationSlots->take(6) as $slot)
                                    <div class="group/slot bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl p-4 border border-purple-200 hover:shadow-lg transition-all duration-300">
                                        <div class="flex items-center justify-between mb-3">
                                            <div class="flex items-center">
                                                <svg class="w-5 h-5 text-purple-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                                </svg>
                                                <span class="text-lg font-semibold text-gray-900">{{ $slot->time_from }} - {{ $slot->time_to }}</span>
                                            </div>
                                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium {{ $slot->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    <h3 class="text-2xl font-bold text-white">
                                        <a href="{{ route('admin.restaurants.places.index', $restaurant) }}" class="hover:text-blue-100 transition-colors duration-200">
                                            ადგილები
                                        </a>
                                    </h3>
                        ...
                        @if ($restaurant->places->count() > 0)
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                @foreach ($restaurant->places->take(4) as $place)
                                    <div class="group/place bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-200 hover:shadow-lg transition-all duration-300">
                                        <div class="flex gap-4 items-start">
                                            @if($place->image)
                                                <img src="{{ $place->image }}" alt="სივრცის ფოტო" class="w-16 h-16 object-cover rounded-xl border-2 border-white shadow-sm group-hover/place:scale-105 transition-transform duration-300">
                                            @else
                                                <div class="w-16 h-16 flex items-center justify-center bg-blue-100 rounded-xl border-2 border-white text-blue-400 shadow-sm group-hover/place:scale-105 transition-transform duration-300">
                                            ...
                                            <div class="flex-1">
                                                <div class="flex justify-between items-start mb-3">
                                                    ...
                                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium {{ $place->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
                                                ...
                                                <div class="flex items-center mb-3">
                                                    ...
                                                    <span class="text-sm text-gray-600">{{ $place->tables->count() }} მაგიდა</span>
                                                </div>
                    ...
                    <div class="relative bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500 px-8 py-6">
                        ...
                        <div class="relative flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <h3 class="text-2xl font-bold text-white">
                                        <a href="{{ route('admin.restaurants.menu.categories.index', $restaurant) }}" class="hover:text-yellow-100 transition-colors duration-200">
                                            მენიუს კატეგორიები
                                        </a>
                                    </h3>
                        ...
                        @if ($restaurant->menuCategories->whereNull('parent_id')->count() > 0)
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                @foreach ($restaurant->menuCategories->whereNull('parent_id')->take(6) as $category)
                                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden border border-gray-100 dark:border-gray-700">
                                        {{-- Category Image --}}
                                        <div class="relative h-32 bg-gradient-to-br from-orange-50 to-amber-100 dark:from-gray-700 dark:to-gray-600 overflow-hidden">
                                            @if ($category->image)
                                            ...
                                            @else
                                                <div class="w-full h-full flex items-center justify-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-orange-400 dark:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                            ...
                                            <div class="absolute top-2 right-2">
                                                @if ($category->status === 'active')
                                                    <span class="inline-flex items-center px-2 py-1 text-xs font-medium rounded-full bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100 shadow-sm">
                                                        <div class="w-1 h-1 bg-green-500 rounded-full mr-1"></div>
                                                        აქტიური
                                                    </span>
                                                @else
                                                    <span class="inline-flex items-center px-2 py-1 text-xs font-medium rounded-full bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm">
                                            ...
                                            <div class="absolute top-2 left-2">
                                                <span class="inline-flex items-center px-2 py-1 text-xs font-bold rounded-full bg-white/90 text-gray-700 dark:bg-gray-800/90 dark:text-gray-200 shadow-sm backdrop-blur-sm">
                                                    #{{ $category->rank ?? 0 }}
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="mt-6 text-center">
                                    <a href="{{ route('admin.restaurants.menu.categories.index', $restaurant) }}" 
                                       class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
                                        ...
                                        ყველას ნახვა ({{ $restaurant->menuCategories->whereNull('parent_id')->count() }})
                                    </a>
                                </div>
                            @endif
                        @else
            ...
            <div class="space-y-8">
                ...
                @if ($restaurant->qr_code_image || $restaurant->qr_code_link)
                    <div class="bg-white/90 backdrop-blur-lg rounded-3xl shadow-xl border border-white/30 overflow-hidden hover:shadow-2xl transition-all duration-500 group">
                        <div class="relative bg-gradient-to-r from-violet-500 via-purple-600 to-indigo-600 px-6 py-4">
                            <div class="absolute inset-0 bg-black/10"></div>
                            <div class="relative flex items-center">
                                <div class="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center mr-3 group-hover:rotate-12 transition-transform duration-300">
                        ...
                        <div class="p-6 text-center">
                            @if ($restaurant->qr_code_link)
                                <a href="{{ $restaurant->qr_code_link }}" target="_blank" class="inline-flex items-center text-sm text-blue-600 hover:text-blue-800 mb-4 transition-colors duration-200">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                                    </svg>
                            ...
                            @if ($restaurant->qr_code_image)
                                <div class="inline-block p-3 bg-white rounded-2xl shadow-lg border border-gray-200">
                                    <img src="{{ $restaurant->qr_code_image }}" alt="QR Code" class="w-32 h-32 object-contain">
                                </div>
                            @endif
                        </div>
                    </div>
                ...
                <div class="bg-white/90 backdrop-blur-lg rounded-3xl shadow-xl border border-white/30 overflow-hidden hover:shadow-2xl transition-all duration-500 group">
                    <div class="relative bg-gradient-to-r from-emerald-500 via-teal-600 to-cyan-600 px-6 py-4">
                        <div class="absolute inset-0 bg-black/10"></div>
                        <div class="relative flex items-center">
                            <div class="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center mr-3 group-hover:scale-110 transition-transform duration-300">
                                <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-6 4h6m-6 4h6m-6 4h6m-3-12v12m3-12v12M9 21h6a2 2 0 002-2V7a2 2 0 00-2-2H9a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                </svg>
                            </div>
                    ...
                    <div class="p-6 space-y-4">
                        <!-- Total Reservations -->
                        <div class="flex justify-between items-center p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200 group/stat hover:shadow-md transition-all duration-300">
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center mr-3 group-hover/stat:scale-110 transition-transform duration-300">
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                                    </svg>
                                </div>
                            ...
                            <span class="text-xl font-bold text-gray-900">{{ $restaurant->reservations()->count() }}</span>
                        </div>

                        <!-- Confirmed Reservations -->
                        <div class="flex justify-between items-center p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200 group/stat hover:shadow-md transition-all duration-300">
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-green-500 rounded-lg flex items-center justify-center mr-3 group-hover/stat:scale-110 transition-transform duration-300">
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-xl font-bold text-gray-900">{{ $restaurant->reservations()->where('status', 'Confirmed')->count() }}</span>
                        </div>

                        <!-- Pending Reservations -->
                        <div class="flex justify-between items-center p-3 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl border border-yellow-200 group/stat hover:shadow-md transition-all duration-300">
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-yellow-500 rounded-lg flex items-center justify-center mr-3 group-hover/stat:scale-110 transition-transform duration-300">
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                    </svg>
                                </div>
                            ...
                            <span class="text-xl font-bold text-gray-900">{{ $restaurant->reservations()->where('status', 'Pending')->count() }}</span>
                        </div>

                        <!-- Cancelled Reservations -->
                        <div class="flex justify-between items-center p-3 bg-gradient-to-r from-gray-50 to-slate-50 rounded-xl border border-gray-200 group/stat hover:shadow-md transition-all duration-300">
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-gray-500 rounded-lg flex items-center justify-center mr-3 group-hover/stat:scale-110 transition-transform duration-300">
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-xl font-bold text-gray-900">{{ $restaurant->reservations()->where('status', 'Cancelled')->count() }}</span>
                        </div>
                ...
                <div class="bg-white/90 backdrop-blur-lg rounded-3xl shadow-xl border border-white/30 overflow-hidden hover:shadow-2xl transition-all duration-500 group">
                    ...
                    <div class="p-6 space-y-4">
                        <!-- Places -->
                        <div class="flex justify-between items-center p-3 bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl border border-indigo-200 group/stat hover:shadow-md transition-all duration-300">
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-indigo-500 rounded-lg flex items-center justify-center mr-3 group-hover/stat:scale-110 transition-transform duration-300">
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                                    </svg>
                                </div>
                        ...
                        <!-- Tables -->
                        <div class="flex justify-between items-center p-3 bg-gradient-to-r from-purple-50 to-violet-50 rounded-xl border border-purple-200 group/stat hover:shadow-md transition-all duration-300">
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-purple-500 rounded-lg flex items-center justify-center mr-3 group-hover/stat:scale-110 transition-transform duration-300">
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-xl font-bold text-gray-900">{{ $restaurant->places->sum(fn($place) => $place->tables->count()) }}</span>
                        </div>

                        <!-- Menu Categories -->
                        <div class="flex justify-between items-center p-3 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl border border-orange-200 group/stat hover:shadow-md transition-all duration-300">
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-orange-500 rounded-lg flex items-center justify-center mr-3 group-hover/stat:scale-110 transition-transform duration-300">
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                                    </svg>
                                </div>
                            ...
                            <span class="text-xl font-bold text-gray-900">{{ $restaurant->menuCategories->count() }}</span>
                        </div>

                        <!-- Slots -->
                        <div class="flex justify-between items-center p-3 bg-gradient-to-r from-pink-50 to-rose-50 rounded-xl border border-pink-200 group/stat hover:shadow-md transition-all duration-300">
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-pink-500 rounded-lg flex items-center justify-center mr-3 group-hover/stat:scale-110 transition-transform duration-300">
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                    </svg>
                                </div>
                            ...
                            <span class="text-xl font-bold text-gray-900">{{ $restaurant->reservationSlots->count() }}</span>
                        </div>
                    </div>
                </div>
