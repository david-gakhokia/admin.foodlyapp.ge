...
namespace Illuminate\Routing {
    ...
    class Router {
        ...
        {
            return \Illuminate\Routing\Router::mobile();
        }
        ...
        {
            return \Illuminate\Routing\Router::webapp();
        }
        ...
        {
            return \Illuminate\Routing\Router::kiosk();
        }
        ...
        {
            return \Illuminate\Routing\Router::publicApi();
        }
         ...
         * @static 
         */
        public static function softwareApi()
        {
            return \Illuminate\Routing\Router::softwareApi();
        }
